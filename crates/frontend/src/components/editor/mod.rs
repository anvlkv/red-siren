...
use super::{Button, RangeSlider, SliderValue};
    ...
    view! {
        <div class="w-full h-full min-h-0 overflow-auto px-4 py-4 md:px-8 md:py-6">
            <div class="mx-auto flex w-full max-w-5xl flex-col gap-4">
                <div class="rounded-xl border-2 border-black/20 bg-black/5 p-4 dark:border-red/20 dark:bg-red/5">
                    <p class="text-base md:text-lg">"Layout editing will live here."</p>
                    <p class="text-sm opacity-80">
                        "This is a stub panel for the routed editor tab."
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full h-full min-h-0 overflow-auto px-4 py-4 md:px-8 md:py-6">
            <div class="mx-auto flex w-full max-w-5xl flex-col gap-6">
                <form on:submit=on_submit>
                    <div class="flex min-w-[900px] flex-col gap-6">
