...
pub fn run() {
    ...
    builder = builder.invoke_handler(tauri::generate_handler![
        ...
        instrument::instrument_set_layout,
        instrument::instrument_set_layout_space,
        instrument::instrument_set_layout_resize_lock,
        instrument::instrument_get_layout_resize_lock,
