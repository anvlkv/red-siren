...
description: 'Style Leptos UI with Tailwind CSS, reactive class patterns, theme tokens, and dark mode conventions in this workspace.'
---
...
- Reviewing whether behavior belongs in Tailwind utilities, shared CSS, or Leptos reactive attributes.
...
7. Before finishing, verify that styling works across desktop and mobile-sized layouts and that utility classes remain consistent with the workspace visual language.
