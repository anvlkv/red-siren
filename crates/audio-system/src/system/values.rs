...
const NODE_BELL_GAIN_DB: f32 = 2.9;
const NODE_FOLLOW_RESPONSE_TIME_S: f32 = 0.0075;
const GROUP_Q: f32 = 2.737;
const GROUP_LS_GAIN_DB: f32 = 1.8;
const FORMANT_BASE_Q: f32 = 3.7;
const FILTER_MORPH_FOLLOW_S: f32 = 0.05;
const FILTER_Q_PIERCING: f32 = 1.3;
const FILTER_Q_BRIGHT: f32 = 1.4;
const FILTER_Q_SHELF: f32 = 3.996;
const FILTER_SHELF_GAIN_DB: f32 = 3.8;
const FILTER_Q_WARM: f32 = 8.095;
